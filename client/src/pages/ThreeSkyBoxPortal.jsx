...
const store = [
  { name: 'outside', color: 'lightpink', position: [10, 0, -15], url: '/360image/inside.jpg', link: 1 },
  { name: 'inside', color: 'lightblue', position: [15, 0, 0], url: '/360image/outside.jpg', link: 0 }
  // ...
]
...
export default ThreeSkyBoxPortal;
